    ...
    <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="<?php echo BASE_URL; ?>profil" class="btn btn-sm btn-dark float-right">Back</a>
                    <form method="POST">

                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-xl  text-[#080808]">Full Name</label>
                        ...
                        <div class="mb-6">
                            <label for="username" class="block mb-2 text-xl  text-[#080808]">Username</label>
                        ...
                        <div class="mb-6">
                            <label for="telephone" class="block mb-2 text-xl  text-[#080808]">Phone</label>
                        ...
                        <div class="mb-6">
                            <label for="email" class="block mb-2 text-xl  text-[#080808]">Email Address</label>
                        ...
                        <div class="mb-6">
                            <label for="adresse" class="block mb-2 text-xl  text-[#080808]"> Address</label>
                        ...
                        <div class="mb-6">
                            <button type="submit" name="update" class="bg-[#f75757] text-[#FBF8F3] rounded-full w-full h-10 cursor-pointer font-bold  duration-500 ease-in-out hover:scale-95">Update</button>
                        </div>
