  ...
  <div class="col-xl-auto col-lg-auto">
    ...
    <form class="mt-6"  method="POST">
      <div>
        ...
        <input type="text" name="email" id="email" placeholder="Enter Email" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-orange-500 focus:bg-white focus:outline-none" autofocus autocomplete required>
      </div>
