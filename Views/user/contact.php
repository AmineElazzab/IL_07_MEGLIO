						...
						<div class="col-lg-6 d-flex align-items-stretch">
							<div class="info-wrap w-100 p-5">
								...
								<div class="dbox w-100 d-flex align-items-start">
									...
									<div class="text pl-4">
										<p>  <i class="fa fa-map-marker-alt"></i><span> Address:</span> 14 Av. Zerktouni, Safi</p><br />
									</div>
								</div>
								<div class="dbox w-100 d-flex align-items-start">
									<div class="icon d-flex align-items-center justify-content-center">
									...
									<div class="text pl-4">
										<p><i class="fa fa-phone-volume"></i><span> Phone:</span> <a href="tel:+212613872479">+212 613872479</a></p><br />
									</div>
								</div>
								<div class="dbox w-100 d-flex align-items-start">
									<div class="icon d-flex align-items-center justify-content-center">
									...
									<div class="text pl-4">
										<p><i class="fa fa-paper-plane"></i><span> Email:</span> <a href="mailto:ma.elazzab@gmail.com">ma.elazzab@gmail.com</a></p><br />
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-5">
							<div class="contact-wrap  p-md-5 ">
								<h3 class="">Get in touch <i class="fa fa-envelope"></i></h3>
							</div>
