                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="size">
                                    ...
                                    <option value="Standard">36</option>
                                    <option value="Standard">37</option>
                                    <option value="Standard">38</option>
                                    <option value="Standard">41</option>
                                    <option value="Standard">42</option>
                                    <option value="Standard">43</option>
