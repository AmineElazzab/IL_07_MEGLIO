...
if (isset($_SESSION["admin"]) && $_SESSION["admin"] == true){
    if (isset($_POST["submit"])){
        $product = new CategorieController();
        $product->newCategory();
    }
}else{
    Redirect::to("landing");
...
<div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
    ...
    <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white z-20" id="nav-content">
        <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
            ...
            <li class="mr-6 my-2 md:my-0">
                <a href="<?php echo BASE_URL; ?>Categorie" class="block py-1 md:py-3 pl-1 align-middle text-red-500 no-underline hover:text-gray-900 border-b-2 ">
                    ...
                    <div class="card-body">
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name_categorie" placeholder="Enter Category Name" required>
                            </div>
